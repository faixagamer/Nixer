...
A Rocket League bot powered by deep reinforcement learning. Trained with PPO to play Soccar, Hoops, and Heatseeker.

---

## 🎮 How to Play Against Nixer

### Prerequisites

| Software | Download |
|----------|----------|
| **RLBot V5** | [Installer](https://github.com/RLBot/launcher/releases/download/installer/rlbot-v5-installer.msi) |
| **Nixer** | [Latest Release](https://github.com/faixagamer/Nixer/archive/refs/heads/main.zip) |

&gt; New to RLBot? [Watch this tutorial](https://www.youtube.com/watch?v=7YdnEkzaRtI)

### Installation

1. Install **RLBot V5** via the installer above
...
1. Click **Add/Remove**
2. Click **Add File**
3. Select `bot.toml` from the extracted `Nixer-Main` folder
